...
import 'package:food_recipe/pages/detail_page.dart';
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text('Popular Recipes', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                Text(
                  'See all',
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(itemRecipes.type, style: TextStyle(fontSize: 16, color: Colors.grey.shade600)),
                                      ...
                                      Row(
                                        children: [
                                          CircleAvatar(radius: 12, backgroundImage: AssetImage(itemAuthors.imageUrl)),
